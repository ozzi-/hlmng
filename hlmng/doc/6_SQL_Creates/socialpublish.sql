...
--
-- Table structure for table `socialpublish`
--
...
--
-- Dumping data for table `socialpublish`
--

LOCK TABLES `socialpublish` WRITE;
/*!40000 ALTER TABLE `socialpublish` DISABLE KEYS */;
/*!40000 ALTER TABLE `socialpublish` ENABLE KEYS */;
UNLOCK TABLES;
