...
CREATE TABLE `vote` (
  ...
  CONSTRAINT `sliderIDFK_vo` FOREIGN KEY (`sliderIDFK`) REFERENCES `slider` (`sliderID`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `userIDFK_vo` FOREIGN KEY (`userIDFK`) REFERENCES `user` (`userID`) ON DELETE NO ACTION ON UPDATE CASCADE
