...
CREATE TABLE `eventroom` (
  ...
  CONSTRAINT `eventIDFK_er` FOREIGN KEY (`eventIDFK`) REFERENCES `event` (`eventID`) ON DELETE CASCADE ON UPDATE CASCADE
...
LOCK TABLES `eventroom` WRITE;
/*!40000 ALTER TABLE `eventroom` DISABLE KEYS */;

/*!40000 ALTER TABLE `eventroom` ENABLE KEYS */;
UNLOCK TABLES;
