...
--
-- Table structure for table `presentationpause`
--
...
--
-- Dumping data for table `presentationpause`
--

LOCK TABLES `presentationpause` WRITE;
/*!40000 ALTER TABLE `presentationpause` DISABLE KEYS */;
/*!40000 ALTER TABLE `presentationpause` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2015-06-08 19:29:22
